...
import (
	dto "zenthara/internal/domain/dto/speaking"
	"zenthara/internal/services/speaking"
...
type EvaluationHandler struct {
	evaluationService speaking.EvaluationService
	logger            zerolog.Logger
	response          response.Response
}

func NewEvaluationHandler(es speaking.EvaluationService, logger zerolog.Logger) *EvaluationHandler {
